...
elseif($_GET['type']==1)$remote_server='http://bos3.yandui.com/api/data/makeSettlementOutDoApi';  //接口地址申请结算单
elseif($_GET['type']==2)$remote_server='http://bos3.yandui.com/api/data/makeSettlementOutDoOkApi';  //接口地址确认结算单
elseif($_GET['type']==3)$remote_server='http://bos3.yandui.com/api/data/addOneDayOutDataApi';  //接口地址同步成本数据
